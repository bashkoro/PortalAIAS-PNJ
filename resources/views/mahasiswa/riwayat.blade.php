...
<div class="flex flex-col md:flex-row">
    ...
    <div class="bg-white border-r border-gray-200 h-16 fixed bottom-0 md:sticky md:top-0 md:h-screen z-30 w-full md:w-64 border-t md:border-t-0">
        ...
        <ul class="flex flex-row md:flex-col py-0 md:py-4 text-center md:text-left justify-around md:justify-start w-full h-full md:h-auto">
            ...
            <li class="flex-1 md:w-full md:mb-2">
                <a href="{{ route('mahasiswa.riwayat') }}" class="block py-3 md:py-3 pl-1 align-middle text-blue-600 no-underline border-b-4 border-blue-600 md:border-b-0 md:border-l-4 hover:bg-gray-50 transition-colors bg-blue-50">
                    ...
                    <table class="min-w-full bg-white">
                        ...
                        <tbody class="text-gray-700 text-sm">
                            ...
                            <tr class="hover:bg-gray-50 border-b border-gray-100 transition-colors">
                                ...
                                <td class="py-4 px-6 text-center">
                                    <span class="bg-blue-50 text-blue-700 py-1 px-3 rounded-full text-xs font-bold">{{ $item->tugas->tingkatAiasAkhir->nama_tingkat ?? '-' }}</span>
                                </td>
                                <td class="py-4 px-6 text-center">
