...
@section('content')
    ...
    <!-- Header Section -->
    <div class="bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100/80 p-8 mb-8">
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
            <div class="flex items-center">
                <div class="h-16 w-16 rounded-2xl bg-emerald-600 flex items-center justify-center text-white text-2xl shadow-lg shadow-indigo-100 mr-6 shrink-0 uppercase font-bold">
                ...
                <div>
                    ...
                    <div class="flex flex-wrap gap-3 mt-2">
                        ...
                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold bg-emerald-50 text-emerald-700 border border-indigo-100 uppercase">
    ...
    <div class="mt-8">
        <h3 class="text-lg font-semibold text-gray-800 mb-4 flex items-center gap-2">
            <i class="fas fa-tasks text-emerald-600"></i> Daftar Penugasan
        </h3>

        @if($tugas->isEmpty())
            <div class="bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100/80 p-12 text-center">
                ...
                <h3 class="text-2xl font-extrabold text-gray-900 tracking-tight mb-2">Belum ada penugasan</h3>
                        ...
                        <tbody class="text-gray-700 text-sm divide-y divide-gray-100">
                            ...
                            <tr class="hover:bg-emerald-50/30 transition-colors group">
                                ...
                                <td class="py-4 px-6 text-center">
                                    ...
                                    @else
                                        <a href="{{ route('mahasiswa.deklarasi.create', ['tugas_id' => $item->id]) }}" class="inline-flex items-center justify-center bg-emerald-600 hover:bg-emerald-700 text-white text-[11px] font-bold py-2 px-4 rounded-lg shadow-sm transition-all shadow-indigo-100">
