...
@section('content')
    ...
    <div class="p-4 md:p-8 max-w-4xl mx-auto">
        ...
        <div class="mb-6">
            <a href="{{ route('mahasiswa.dashboard') }}" class="text-sm font-medium text-gray-500 hover:text-emerald-600 transition-colors flex items-center gap-2">
        ...
        <!-- Task Detail Card -->
        <div class="bg-white shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-2xl border border-gray-100/80 border border-gray-200 mb-6 overflow-hidden text-gray-900">
            <div class="bg-emerald-50 border-b border-blue-100 p-6">
                <div class="flex items-center gap-2 mb-2">
                    <span class="text-emerald-700 text-[10px] font-bold uppercase tracking-wider bg-white px-2 py-0.5 rounded border border-blue-200 shadow-sm">Detail Tugas</span>
            ...
            <div class="p-6 bg-white flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div class="flex items-center gap-4">
                    <div class="p-3 bg-emerald-600 text-white rounded-xl shadow-lg shadow-blue-100">
                        <i class="fas fa-shield-alt text-xl"></i>
                    </div>
                    <div>
                        <p class="text-[10px] text-gray-400 font-black uppercase tracking-tighter">Batas Penggunaan AI</p>
                        <div class="flex items-center gap-2 text-gray-900">
                            <span class="text-lg font-black text-emerald-700">{{ $tugas->tingkatAiasAkhir->nama_tingkat ?? 'N/A' }}</span>
            ...
            <div class="bg-white shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-2xl border border-gray-100/80 border border-gray-200 overflow-hidden">
                ...
                <div class="p-6 space-y-6">
                    <div>
                        ...
                        <input type="text" name="nama_platform_ai" id="nama_platform_ai" value="{{ old('nama_platform_ai') }}" class="w-full bg-gray-50 border border-gray-200 rounded-lg shadow-sm py-3 px-4 focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all text-sm text-gray-800 placeholder-gray-300 font-medium" placeholder="ChatGPT 4o, Claude 3.5 Sonnet, dll...">
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <textarea name="prompt_dikirim" id="prompt_dikirim" rows="4" class="w-full bg-gray-50 border border-gray-200 rounded-lg shadow-sm py-3 px-4 focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all text-sm text-gray-800 placeholder-gray-300 font-medium" placeholder="Contoh: 'Buatlah kerangka makalah tentang...' atau 'Perbaiki tata bahasa paragraf ini...'">{{ old('prompt_dikirim') }}</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea name="respons_ai" id="respons_ai" rows="4" class="w-full bg-gray-50 border border-gray-200 rounded-lg shadow-sm py-3 px-4 focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all text-sm text-gray-800 placeholder-gray-300 font-medium" placeholder="Ringkas secara singkat apa yang dihasilkan AI dan bagaimana Anda menggunakannya...">{{ old('respons_ai') }}</textarea>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="url" name="link_conversation" id="link_conversation" value="{{ old('link_conversation') }}" class="w-full bg-gray-50 border border-gray-200 rounded-lg shadow-sm py-3 px-4 focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all text-sm text-gray-800 placeholder-gray-300 font-medium" placeholder="https://chatgpt.com/share/...">
                    </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8 shadow-blue-50 shadow-inner">
                <div class="flex items-start">
                    <div class="flex items-center h-5">
                        <input id="pernyataan_disetujui" name="pernyataan_disetujui" type="checkbox" value="1" class="h-6 w-6 text-emerald-600 border-gray-300 rounded-lg focus:ring-emerald-500 cursor-pointer shadow-sm" required>
                    </div>
                    <div class="ml-4">
