...
<head>
    ...
    <title>Manajemen Pengguna - Portal Asesmen AI</title>
...
<div class="flex flex-col md:flex-row">
    ...
    <div class="bg-white border-r border-gray-200 h-16 fixed bottom-0 md:sticky md:top-0 md:h-screen z-30 w-full md:w-64 border-t md:border-t-0">
        ...
        <ul class="flex flex-row md:flex-col py-0 md:py-4 text-center md:text-left justify-around md:justify-start w-full h-full md:h-auto">
            ...
            <li class="flex-1 md:w-full md:mb-2">
                <a href="{{ route('admin.users.index') }}" class="block py-3 md:py-3 pl-1 align-middle text-blue-600 no-underline border-b-4 border-blue-600 md:border-b-0 md:border-l-4 hover:bg-gray-50 transition-colors bg-blue-50">
                    <i class="fas fa-users pr-0 md:pr-3 text-blue-600 ml-4"></i><span class="pb-1 md:pb-0 text-sm md:text-base text-blue-600 font-medium md:font-semibold block md:inline-block">Pengguna</span>
                </a>
            </li>
            <li class="flex-1 md:w-full md:mb-2">
    ...
    <div class="main-content flex-1 bg-gray-100 mt-12 md:mt-0 pb-24 md:pb-5">
        ...
        <div class="bg-white border-b border-gray-200 w-full p-4 flex justify-between items-center sticky top-0 z-20 h-[73px]">
            <h1 class="text-xl md:text-2xl font-bold text-gray-800 hidden md:block">Manajemen Pengguna</h1>
            <div class="md:hidden">
                <div class="flex items-center gap-3">
                    <div class="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-600 to-purple-600 flex items-center justify-center shadow-md">
                        <span class="text-white font-bold text-sm">AI</span>
            ...
            <div class="bg-white shadow-sm rounded-lg border border-gray-100 overflow-hidden">
                <div class="px-6 py-5 border-b border-gray-200 bg-gray-50 flex justify-between items-center">
                    <div>
                        ...
                        <p class="text-sm text-gray-500">Kelola akses dan data dosen maupun mahasiswa.</p>
                    </div>
                    <button class="bg-black hover:bg-gray-800 text-white text-sm font-semibold py-2 px-4 rounded shadow transition-colors">
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full bg-white">
                        <thead class="bg-gray-50 text-gray-600 text-sm uppercase font-semibold">
                            <tr>
                                <th class="py-3 px-6 text-center border-b border-gray-200 w-16">ID</th>
                                <th class="py-3 px-6 text-left border-b border-gray-200">Nama Lengkap</th>
                        ...
                        <tbody class="text-gray-700 text-sm">
                            ...
                            <tr class="hover:bg-gray-50 border-b border-gray-100 transition-colors">
                                <td class="py-4 px-6 text-center text-gray-500">{{ $user->id }}</td>
                                <td class="py-4 px-6 text-left font-medium text-gray-900">{{ $user->nama }}</td>
                                ...
                                <td class="py-4 px-6 text-center">
                                    <span class="bg-gray-100 text-gray-800 py-1 px-3 rounded-md text-xs font-semibold">{{ $user->hakAkses->nama_hak_akses ?? '-' }}</span>
                                </td>
                                <td class="py-4 px-6 text-center">
                                    <div class="flex item-center justify-center">
                                        <button class="w-4 mr-2 transform hover:text-blue-600 hover:scale-110">
                            ...
                            @empty
                            <tr>
                                <td colspan="6" class="py-8 px-6 text-center text-gray-500">Tidak ada data.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
