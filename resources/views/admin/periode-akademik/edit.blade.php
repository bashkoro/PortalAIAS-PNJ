...
<head>
    ...
    <title>Edit Periode Akademik - Portal Asesmen AI</title>
...
<div class="flex flex-col md:flex-row">
    ...
    <div class="bg-white border-r border-gray-200 h-16 fixed bottom-0 md:sticky md:top-0 md:h-screen z-30 w-full md:w-64 border-t md:border-t-0">
        ...
        <ul class="flex flex-row md:flex-col py-0 md:py-4 text-center md:text-left justify-around md:justify-start w-full h-full md:h-auto">
            ...
            <li class="flex-1 md:w-full md:mb-2">
                <a href="{{ route('admin.periode-akademik.index') }}" class="block py-3 md:py-3 pl-1 align-middle text-blue-600 no-underline border-b-4 border-blue-600 md:border-b-0 md:border-l-4 hover:bg-gray-50 transition-colors bg-blue-50">
                    <i class="fas fa-calendar-alt pr-0 md:pr-3 ml-4 text-blue-600"></i><span class="pb-1 md:pb-0 text-sm md:text-base text-blue-600 font-medium md:font-semibold block md:inline-block">Periode Akademik</span>
                </a>
            </li>
    ...
    <div class="main-content flex-1 bg-gray-100 mt-12 md:mt-0 pb-24 md:pb-5">
        ...
        <div class="bg-white border-b border-gray-200 w-full p-4 flex justify-between items-center sticky top-0 z-20 h-[73px]">
            <h1 class="text-xl md:text-2xl font-bold text-gray-800 hidden md:block">Edit Periode Akademik</h1>
            <div class="md:hidden">
                <div class="flex items-center gap-3">
                    <div class="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-600 to-purple-600 flex items-center justify-center shadow-md">
                        <span class="text-white font-bold text-sm">AI</span>
            ...
            <div class="max-w-2xl">
                ...
                <div class="bg-white shadow-sm rounded-lg border border-gray-100 p-8">
                    <div class="border-b border-gray-100 pb-5 mb-6">
                        <h3 class="text-xl font-bold text-gray-900">Edit Data Periode Akademik</h3>
                    ...
                    <form action="{{ route('admin.periode-akademik.update', $periodeAkademik->id) }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="nama_periode" id="nama_periode" value="{{ old('nama_periode', $periodeAkademik->nama_periode) }}" class="block w-full py-2.5 px-3 border border-gray-300 rounded-lg text-sm shadow-sm focus:outline-none focus:border-blue-600 focus:ring-1 focus:ring-blue-600 transition-colors" placeholder="Contoh: 2025/2026 Genap" required>
                            @error('nama_periode')
                        ...
                        <div class="flex items-center">
                            <input type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $periodeAkademik->is_active) ? 'checked' : '' }} class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300 rounded cursor-pointer">
