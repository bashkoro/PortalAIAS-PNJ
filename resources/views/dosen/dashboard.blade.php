...
<head>
    ...
    <title>Dashboard Dosen - Portal Asesmen AI</title>
...
<div class="flex flex-col md:flex-row">
    ...
    <div class="bg-white border-r border-gray-200 h-16 fixed bottom-0 md:sticky md:top-0 md:h-screen z-30 w-full md:w-64 border-t md:border-t-0">
        ...
        <ul class="flex flex-row md:flex-col py-0 md:py-4 text-center md:text-left justify-around md:justify-start w-full h-full md:h-auto">
            <li class="flex-1 md:w-full md:mb-2">
                <a href="{{ route('dosen.dashboard') }}" class="block py-3 md:py-3 pl-1 align-middle text-blue-600 no-underline border-b-4 border-blue-600 md:border-b-0 md:border-l-4 hover:bg-gray-50 transition-colors bg-blue-50">
    ...
    <div class="main-content flex-1 bg-gray-100 mt-12 md:mt-0 pb-24 md:pb-5">
        ...
        <div class="bg-white border-b border-gray-200 w-full p-4 flex justify-between items-center sticky top-0 z-20 h-[73px]">
            <h1 class="text-xl md:text-2xl font-bold text-gray-800 hidden md:block">Dashboard Dosen</h1>
            <div class="md:hidden">
                <div class="flex items-center gap-3">
                    <div class="w-8 h-8 rounded-lg bg-gradient-to-br from-blue-600 to-purple-600 flex items-center justify-center shadow-md">
                        <span class="text-white font-bold text-sm">AI</span>
            ...
            <div class="flex items-center" x-data="{ open: false }">
                <div class="relative">
                    <button @click="open = !open" @click.away="open = false" class="flex items-center gap-2 text-sm font-medium text-gray-700 hover:text-gray-900 focus:outline-none transition duration-150 ease-in-out">
                        ...
                        <img class="h-8 w-8 rounded-full object-cover border border-gray-300 shadow-sm" src="https://ui-avatars.com/api/?name={{ urlencode(Auth::user()->nama ?? 'Dosen Tester') }}&color=1D4ED8&background=EFF6FF" alt="Profile">
        ...
        <div class="p-4 md:p-8">
            <h2 class="text-2xl font-bold text-gray-800 mb-6 md:hidden">Dashboard Dosen</h2>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div class="bg-white rounded-lg shadow-sm p-6 border border-gray-100 flex items-center hover:shadow-md transition-shadow">
                    ...
                    <div>
                        ...
                        <p class="text-3xl font-bold text-gray-800">{{ $totalPenugasan }}</p>
                    </div>
                </div>
                <!-- Card 2 -->
                <div class="bg-white rounded-lg shadow-sm p-6 border border-gray-100 flex items-center hover:shadow-md transition-shadow">
                    ...
                    <div>
                        <p class="mb-1 text-sm font-medium text-gray-500 uppercase tracking-wider">Tugas Aktif</p>
                        <p class="text-3xl font-bold text-gray-800">{{ $tugasAktif }}</p>
                    </div>
                </div>
                <!-- Card 3 -->
                <div class="bg-white rounded-lg shadow-sm p-6 border border-gray-100 flex items-center hover:shadow-md transition-shadow">
                    ...
                    <div>
                        <p class="mb-1 text-sm font-medium text-gray-500 uppercase tracking-wider">Tren Kebijakan AI</p>
                        <p class="text-3xl font-bold text-gray-800">{{ $trenKebijakanAI }}</p>
                    </div>
                </div>
                <!-- Card 4 -->
                <div class="bg-white rounded-lg shadow-sm p-6 border border-gray-100 flex items-center hover:shadow-md transition-shadow">
                    ...
                    <div>
                        <p class="mb-1 text-sm font-medium text-gray-500 uppercase tracking-wider">Deklarasi Masuk</p>
                        <p class="text-3xl font-bold text-gray-800">{{ $deklarasiMasuk }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white shadow-sm rounded-lg border border-gray-100 overflow-hidden">
                <div class="px-6 py-5 border-b border-gray-200 bg-gray-50 flex justify-between items-center">
                    <h3 class="font-bold text-gray-800 text-lg">Penugasan Terbaru</h3>
                    <a href="{{ route('dosen.riwayat') }}" class="text-sm text-blue-600 hover:text-blue-700 font-medium">Lihat Semua →</a>
                </div>
                    ...
                    <table class="min-w-full bg-white">
                        ...
                        <tbody class="text-gray-700 text-sm">
                            ...
                            <tr class="hover:bg-gray-50 border-b border-gray-100 transition-colors">
                                ...
                                <td class="py-4 px-6 text-left">{{ $item->kelasKuliah->mataKuliah->nama_mk ?? '-' }}</td>
                                ...
                                <td class="py-4 px-6 text-center">
                                    @if(strtolower($item->status_publikasi) === 'published')
                                        <span class="bg-blue-50 text-blue-700 py-1 px-3 rounded-full text-xs font-semibold">Dipublikasi</span>
                                    @else
                                        <span class="bg-gray-100 text-gray-800 py-1 px-3 rounded-full text-xs font-semibold">Draft</span>
                                    @endif
                                </td>
                            </tr>
                            @empty
