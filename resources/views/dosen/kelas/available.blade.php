            ...
            <form method="GET" action="{{ url()->current() }}" class="flex flex-col md:flex-row gap-4 items-end md:items-center">
                <div class="w-full md:w-1/3">
                    <div class="relative">
                        ...
                        <input type="text" name="search" value="{{ request('search') }}" placeholder="Cari nama kelas atau MK..." class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-1 focus:ring-blue-500 focus:border-blue-500">
                    </div>
                </div>
                <div class="w-full md:w-1/3">
                    ...
                    <tr class="hover:bg-gray-50 transition-colors">
                        ...
                        <td class="py-4 px-6 text-center">
                            <form action="{{ route('dosen.kelas.claim') }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin mengampu kelas ini?');">
                                ...
                                <button type="submit" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg text-xs font-bold hover:bg-blue-700 transition-all shadow-sm">
